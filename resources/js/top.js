$(document).ready(function () {
    ...
    const taskCategories = {
        稲沢本店: [
            { value: "車検_稲沢（00分開始）", text: "車検（00分開始）" },
            { value: "車検_稲沢（30分開始）", text: "車検（30分開始）" },
            { value: "点検整備・見積もり_稲沢", text: "点検整備・見積もり" },
        ],
        名古屋北店: [
            { value: "車検_名北（00分開始）", text: "車検（00分開始）" },
            {
                value: "車検_名北（30分開始）土曜",
                text: "車検_名北（30分開始）土曜",
            },
            { value: "点検整備・見積もり_名北", text: "点検整備・見積もり" },
        ],
        刈谷店: [
            { value: "車検_刈谷", text: "車検" },
            { value: "点検整備・見積もり", text: "点検整備・見積もり" },
        ],
        錦店: [
            { value: "車検_錦", text: "車検" },
            { value: "点検整備・見積もり", text: "点検整備・見積もり" },
    ...
    const reservationTasks = {
        ...
        点検整備・見積もり_名北: [
            ...
            {
                value: "★個人★タイヤ付替え[タイヤのみ](30分)",
                text: "★個人★タイヤ付替え[タイヤのみ](30分)",
            },
            {
    ...
    function updateTaskCategories(store) {
        const categories = taskCategories[store];
        const $container = $("#taskCategories");
        ...
        categories.forEach((category) => {
            const $label = $(`<label class="custom-radio-button">
            <input type="radio" name="taskcategory" value="${category.value}" class="hidden-radio rounded-md">
            <span class="custom-button3">
                <span class="icon">✓</span> ${category.text}
            </span>
        </label>`);
            $container.append($label);
        });

        // タスクカテゴリのラジオボタン選択時のイベント
    ...
    function updateReservationTasks(taskCategory) {
        const tasks = reservationTasks[taskCategory];
        const $container = $("#reservationTasks");
        ...
        tasks.forEach((task) => {
            ...
            <label class="custom-checkbox">
                <input type="checkbox" name="reservationtask" value="${task.value}">
                <span>${task.text}</span>
            </label>
            ...
            <div class="text-red-600 font-bold px-2 text-right inline-block border-b border-red-600">さらに詳しく</div>
                </div><hr class="my-3 border-1 border-red-300 mx-10">`);
            $container.append($label);
        });
    }
});
