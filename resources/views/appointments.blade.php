            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('appointments.store') }}">
                        ...
                        <div class="mt-4">
                            <x-input-label for="vehicle_name_registration" value="車両番号登録" />
                            <x-text-input id="vehicle_name_registration" class="block mt-1 w-full" name='vehicle_name_registration'/>
                        </div>
                        <div class="mt-4">
                            <x-input-label for="vehicle_type" value="車両タイプ" />
                            <x-select id="vehicle_type" class="block mt-1 w-full" name="vehicle_type"
                        ...
                        <div class="mt-4">
                            <x-input-label for="number_plate" value="ナンバープレート" />
                            <x-text-input id="number_plate" class="block mt-1 w-full" name='number_plate'/>
                        </div>
                        <div class="mt-4">
                            <x-input-label for="vehicle_expiration_date" value="車両満了日" />
                            <x-text-input id="vehicle_expiration_date" class="block mt-1 w-full" name='vehicle_expiration_date'/>
                        </div>
                        <div class="mt-4">
                            <x-input-label for="extra_equipment" value="追加装備" />
                            <div><label><input type="checkbox" name="extra_equipment" value="1">エンジンオイル交換</label></div>
                            <div><label><input type="checkbox" name="extra_equipment" value="2">タイヤローテション[前⇔後]</label></div>
                            <div><label><input type="checkbox" name="extra_equipment" value="3">タイヤ付替[夏⇔冬シーズンチェンジ]</label></div>
                        </div> --}}
