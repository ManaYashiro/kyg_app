            ...
            <div class="pt-0 pr-6 pb-6 pl-6 text-gray-900">
                ...
                <form id="reservation-submit--form" method="POST" action="{{ route('appointments.confirm') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-ajax-input-error id="error-user_vehicle_id" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-ajax-input-error id="error-additional_services" />
                        <x-input-error :messages="$errors->get('additional_services')" class="attention" />
                    </div>
                    <!-- 車検満期日 -->
                    <div class="mt-4">
                        <h5>
                        ...
                        <x-text-data-input id="inspection_due_date" type="text" name="inspection_due_date"
                            :value="old('inspection_due_date', $inspection_due_date)" :addClass="'validateNumeric'" class="datepicker block mt-1 w-full rounded-none"
                            required />
                        <x-text.custom-input-label text="（記入例：2022/10/30）"
                            spanClass="font-normal text-xs text-gray-500 mt-1" />
                        <x-ajax-input-error id="error-inspection_due_date" />
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text.custom-input-label
                                ...
                                spanClass="font-normal text-xs text-gray-500 mt-1" />
                            <x-ajax-input-error id="error-past_service_history" />
