                                ...
                                <div class="flex justify-between gap-6">
                                    <div class="w-full">
                                        ...
                                        <div class="flex items-center gap-4 mb-4">
                                            <label for="role"
                                                class="text-xs font-medium text-gray-700 w-1/3">Role</label>
                                        ...
                                        <div class="flex gap-6 mb-4">
                                            <div class="flex items-center w-1/2">
                                                ...
                                                <div class="flex items-center">
                                                    <input type="radio" id="registration_oldest"
                                                        name="registration_order" value="oldest"
                                            ...
                                            <div class="flex items-center w-1/2">
                                                ...
                                                <input type="radio" id="update_order_newest" name="update_order"
                                                    value="newest"
                                                    {{ request('update_order') == 'newest' ? 'checked' : '' }}
                                                    class="mr-4">
                                                <div class="flex items-center">
                                                ...
                                                <input type="radio" id="update_order_oldest" name="update_order"
                                                    value="oldest"
                                                    {{ request('update_order') == 'oldest' ? 'checked' : '' }}
                                                    class="mr-4">
                                                <div class="flex items-center">
