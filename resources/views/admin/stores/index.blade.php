                            ...
                            <tbody>
                                @foreach ($stores as $store)
                                    <tr data-url="{{ route('admin.stores.update', $store->id) }}"
                                        ...
                                        <td
                                            class="border px-4 py-2 whitespace-nowrap text-center flex flex-row gap-2 items-center justify-evenly">
                                            ...
                                            <form action="{{ route('admin.stores.destroy', $store->id) }}"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="delete--model bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
