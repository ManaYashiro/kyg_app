    ...
    <div class="bg-white overflow-hidden shadow-sm border border-gray-800 border-r-0 border-b-0">
        ...
        <form method="POST" action="{{ route('profile.update') }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="email" class="block mt-1 w-full" type="text" name="email" :value="old('email', $users->email ?? '')"
                    required />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password" class="block mt-1 w-full" type="text" type="password" name="password"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="address1" class="block mt-1 w-full" type="text" name="address1" :value="old('address1', $users->address1 ?? '')"
                    required />
            ...
            <div class="mt-4">
                ...
                <div class="ml-1 mt-2 flex flex-row gap-3 items-center">
                    <x-text-input id="is_receive_newsletter" type="checkbox" name="is_receive_newsletter"
                        :value="1" :checked="old('is_receive_newsletter', $users->is_receive_newsletter ?? false) ? true : false" />
