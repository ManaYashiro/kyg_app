            ...
            <form method="POST" action="{{ route('appointmentList.confirm') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="hidden" name="reservation_number"
                        value="{{ $appointment->reservation_number ?? '' }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="hidden" name="reservation_datetime"
                        value="{{ $appointment->reservation_datetime ?? '' }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <x-data-display :value="$appointment->reservation_name ?? ''" />
                    <input type="hidden" name="reservation_task_id"
                        value="{{ $appointment->reservation_name ?? '' }}">
                </div>
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="inspection_due_date" type="text" name="inspection_due_date" :value="old(
                        'inspection_due_date',
                        $appointment->inspection_due_date
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-4">
                        <x-radio name="past_service_history" value="A)この店舗・作業どちらも、初めて利用" label="A)この店舗・作業どちらも、初めて利用"
                            :checked="old('past_service_history', $appointment->past_service_history) === 'A)この店舗・作業どちらも、初めて利用'" :disabled="false" class="mt-2" required />
                        ...
                        <x-radio name="past_service_history" value="C)この店舗・作業とも、以前に利用している"
                            label="C)この店舗・作業とも、以前に利用している" :checked="old('past_service_history', $appointment->past_service_history) === 'C)この店舗・作業とも、以前に利用している'" :disabled="false" class="mt-2"
                            required />
                        <x-radio name="past_service_history" value="D)この作業は、弊社の別の店舗で利用した"
                            label="D)この作業は、弊社の別の店舗で利用した" :checked="old('past_service_history', $appointment->past_service_history) === 'D)この作業は、弊社の別の店舗で利用した'" :disabled="false" class="mt-2"
                            required />
                ...
                <div class="flex flex-row items-center justify-center gap-4 mt-8">
                    <div class="w-1/3">
                        <button id="button-prev" class="bg-gray-200 text-black rounded w-full px-4 py-4"
                    ...
                    <div class="w-1/3 block">
                        <button id="button-next" class="bg-red-1000 text-white rounded w-full px-4 py-4"
                            type="submit">
                            確認画面へ
                        </button>
                    </div>
                    ...
                    <div class="w-1/3 block">
                        <button id="button-cancel" class="bg-red-1000 text-white rounded w-full px-4 py-4"
